...
[
    {src:'system/console.html?60',icon:'<span style=color:#0f0;background:#000;font-family:monospace>JS>'},
    {src:'system/wordList.html?5',icon:'📕', sticky:1},
    {src:'system/trophyCase.html?19', icon:'🏆', width:680, sticky:1},
...
[
    ...
    {src:'apps/filters.html?1', icon:'✨', width:400, height:100, resize:0},
