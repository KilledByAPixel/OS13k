...
### System Calls
- The function OS13kStart() is called on child frames immediately after load, when OS13k & zzfx becomes available
...
- sticky (0) - Will automatically open of program on restart if it was open
 ...
 - [JS13k](https://js13kgames.com/) - This is the contest we are entering, check this page for official rules
